...
/**
   #GOAT
    ...
    I make this #GOAT to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/GoatToken
   ...
   I will renounce the ownership to burn addresses to transfer #GOATS to the community, make sure it's 100% safe.

   I will add 0.999 ETH and all the left 49.5% total supply to the pool
   Can you make #GOATS 10000000X? 
   ...
   it's the best part of the #GOATS idea, increasing the liquidity pool automatically, 
